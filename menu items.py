...
menuItem2 = MenuItem(name="Hamburguesa vegana", description="Juicy grilled veggie patty with tomato mayo and lettuce",
...
menuItem1 = MenuItem(name="Papas fritas", description="with garlic and parmesan",
                     price="$2.99", course="Appetizer", restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(name="Hamburguesa de pollo", description="Juicy grilled chicken patty with tomato mayo and lettuce",
                     price="$5.50", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(name="Bizcocho de chocolate", description="fresh baked and served with ice cream",
...
menuItem5 = MenuItem(name="Cerveza Presidente", description="16oz of refreshing goodness",
...
menuItem7 = MenuItem(name="Tostada con queso derretido", description="On texas toast with American Cheese",
